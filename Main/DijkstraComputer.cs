public class DijkstraComputer
{
    ...
    {
        Dictionary<Node, DijkstraMap> mapping = createMapping(from, nodes, _edges);
    ...
    private Dictionary<Node, DijkstraMap> createMapping(Node from, List<Node> nodes, List<Edge> edges)
    {
